...
public class GuiMain05 {
	...
	private void initialize() {
		...
		final JRadioButton rdbtnAgree = new JRadioButton("동의");
		...
		rdbtnAgree.setFont(new Font("Gulim", Font.PLAIN, 12));
		rdbtnAgree.setBounds(8, 6, 121, 23);
		frame.getContentPane().add(rdbtnAgree);
		
		final JRadioButton rdbtnReject = new JRadioButton("거절");
		...
		rdbtnReject.setFont(new Font("Gulim", Font.PLAIN, 12));
		rdbtnReject.setBounds(150, 6, 121, 23);
