...
public class TypeCastingMain {
	public static void main(String[] args) {
		...
		int num3 = 123;
		byte num4 = (byte)num3; // byte < int 이므로 자동 형변환 불가능
		...
		// 주의) num5에 저장된 값이 byte의 범위를 넘어가면 형 변환은 가능하지만 잘못된 값(쓰레기 값)이 저장됨
		
		
		
		short num7 = 12345;
		//12345는 리터럴 (상수)이기 때문에 int ㅌ타입
		// 정수 리터럴 byte나 short에 저장할때
		// 해당 타입이 저장할 수 있는 범위만 넘지 않으면 잗ㅇ 형 변환을 해줌
		// int -> btye , int >> short
		
		// long 타입은 리터럴은 자동 형변환을 하지 않음
//		int num8 = 100L;
